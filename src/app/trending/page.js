...
import { getTrendingProductsAll } from "@/app/api/supabaseQueries";
  ...
  const loadProducts = async (loadMore = false) => {
    try {
      ...
      const { products: newProducts, lastProductId: newLastId, hasMore: more } = 
        await getTrendingProductsAll(loadMore ? lastProductId : null);
  ...
  return (
    <div>
      <div className="container mx-auto px-4 py-8 pt-12">
        <h1 className="text-3xl font-bold mb-8 text-center">Trending Products</h1>
